...
Für 9x9 werden jeweils 10.000/ Anzahl der möglichen Belegungen für die erste Spalte viele Belegungen pro erste Spalte mit Hilfe vom Random_Backtracking berechnet
...
pub fn set_values(grid: &[usize], grid_size: &usize) -> HashSet<Vec<usize>> {
    ...
    if GRID_SIZE == 9{
        ...
        let amount_of_field_per_column = 10000 / amount_of_first_columns;
    ...
    println!("Anzahl der befüllten felder:{}", results.len());
    results
}
